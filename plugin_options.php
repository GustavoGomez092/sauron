      ...
      'fields' => array(
        ...
        [
          ...
          'sub_fields' => [
            ...
            [
              'key' => 'field_663acc26a2b347',
              'label' => 'Use Gradient Background',
              'name' => 'use_gradient_background',
              'graphql_field_name' => 'use_gradient_background',
              'show_in_graphql' => 1,
              'graphql_description' => '',
              'graphql_non_null' => 0,
              'type' => 'true_false',
            ...
            [
              'key' => 'field_44043d1978a47c',
              'label' => 'Color To',
              'name' => 'color_to',
              'graphql_field_name' => 'color_to',
              'show_in_graphql' => 1,
              'graphql_description' => '',
              'graphql_non_null' => 0,
              'type' => 'color_picker',
...
?>
      <script>
        acf.addAction('ready', function($el) {
          ...
          const field = acf.getField('field_679290751b690');
