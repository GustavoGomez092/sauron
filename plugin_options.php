...
class Sauron_plugin_options {
  ...
  */
  public function init() {
    ...
    add_action('acf/init', array( $this, 'add_sauron_settings' ) );
    add_action( 'acf/include_fields', array( $this, 'settings_acf_fields' ) );
  }

  public function register_plugin_settings() {
      register_setting( 'Sauron-settings-group', 'Sauron-plugin' );
  }
  ...
  */
  ...
  public function render_plugin_options_page() {
    echo '<div id="Sauron-options" class="Sauron"></div>';
  }

  public function add_type_attribute_admin($tag, $handle, $src)
  {
      // change the script tag by adding type="module" and return it.
      if ($handle  === 'Sauron-plugin-options-dev') {
...
$plugin_options = new Sauron_plugin_options();
$plugin_options->init();